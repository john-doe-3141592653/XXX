...
for i in range(10):
	...
	for j in range(100):
		os.system("python3 ./" + sys.argv[1] + "/oracle_" + sys.argv[1] + ".py " + sys.argv[1] + "/experiment/" + str(i) + "/test_case_" + str(j) + "/ " + sys.argv[1] + "/experiment/" + str(i) + "/")
		os.system("python3 ./" + sys.argv[1] + "/analysis_" + sys.argv[1] + ".py " + sys.argv[1] + "/experiment/" + str(i) + "/test_case_" + str(j) + "/ " + sys.argv[1] + "/experiment/" + str(i) + "/")
